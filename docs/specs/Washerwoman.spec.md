...
1. **只有自己是鎮民情況**：
   ...
   選擇鎮民角色：
   [下拉選單: 所有鎮民角色，包括不在場的，預選洗衣婦]

   選擇第一位玩家（該鎮民）：
   [下拉選單: 玩家列表，預選 Alice]

   選擇第二位玩家（非該鎮民）：
   [下拉選單: 玩家列表，從非鎮民名單隨機預選]
...
2. **標準情況（有其他鎮民）**：
   ...
   選擇鎮民角色：
   [下拉選單: 所有鎮民角色，包括不在場的，優先預選其他在場鎮民 > 自己]

   選擇第一位玩家（該鎮民）：
   [下拉選單: 所有玩家列表，優先預選其他在場鎮民 > 間諜 >　自己]

   選擇第二位玩家（非該鎮民）：
   [下拉選單: 所有玩家列表，從在場非鎮民名單隨機預選]
...
4. **自己是酒鬼情況**：
   ...
   說書人可以選擇給予錯誤資訊。
   推薦：給予真鎮民角色，挑選兩個完全無關或是只有一個相關的玩家。
