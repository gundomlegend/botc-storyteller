...
export interface ProcessorContext {
  result: NightResult;              // Handler 返回的結果
 ...
 */
export interface RoleProcessorConfig {
  /** 角色 ID */
  roleId: string;
   ...
   */
  getNoTargetButtonText?: (context: ProcessorContext) => string;
   ...
   */
  getNoTargetEventDescription?: (context: ProcessorContext) => string;
}
